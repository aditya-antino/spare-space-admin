  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        info: "border-transparent bg-cyan-500 text-white shadow hover:bg-cyan-600",
        purple:
          "border-transparent bg-purple-500 text-white shadow hover:bg-purple-600",
        outline:
          "text-gray-700 border-gray-300 bg-transparent hover:bg-gray-50",
        ghost: "text-gray-700 border-transparent bg-gray-50 hover:bg-gray-100",
      },
      size: {
